...
public:
  ...
  /* Label handling */
	...
	void emit_label(string const *label) const;
	...
	void emit_move (const Register *reg, const Register *reg2) const;
	...
	void emit_2addr (inst_type inst,
			 const Register *reg, int immediate) const;
	void emit_2addr (inst_type inst,
			 const Register *reg, const Register *src) const;
	void emit_2addr (inst_type inst,
			 const Register *reg, const string *var) const;
	...
	void emit_branch (inst_type inst, 
			  const Register *reg, int dest) const;
	// For conditional branches that target labels
	void emit_branch (inst_type inst,
			  const Register *reg, const string *dest) const;
